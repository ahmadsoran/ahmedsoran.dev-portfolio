...
export default function BlogHero({ searchParams }: BlogHeroProps) {
  ...
  return (
    <section className='relative min-h-[70vh] flex flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-gray-50 via-white to-stone-50 dark:from-gray-900 dark:via-gray-800 dark:to-slate-900'>
