...
export default function HeroSection() {
  return (
    <section
      id='about'
      className='pt-[calc(50px + 10px)] relative min-h-dvh flex flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-gray-50 via-white to-stone-50 dark:from-gray-900 dark:via-gray-800 dark:to-slate-900'>
